...
const Toastify__bounceInLeft = keyframes`
  from,
  60%,
  75%,
  90%,
...
`;
const Toastify__bounceOutLeft = keyframes`
  20% {
    opacity: 1;
    transform: translate3d(20px, 0, 0);
  }
...
const Toastify__bounceInUp = keyframes`
  from,
  60%,
  75%,
  90%,
...
const Toastify__bounceOutUp = keyframes`
  20% {
    transform: translate3d(0, -10px, 0);
  }
  40%,
...
const Toastify__bounceInDown = keyframes`
  from,
  60%,
  75%,
  90%,
...
const Toastify__bounceOutDown = keyframes`
  20% {
    transform: translate3d(0, 10px, 0);
  }
  40%,
...
const Toastify__zoomIn = keyframes`
  from {
    opacity: 0;
...
const Toastify__zoomOut = keyframes`
  from {
    opacity: 1;
  }
  50% {
...
const Toastify__flipIn = keyframes`
  from {
...
const Toastify__flipOut = keyframes`
  from {
    transform: perspective(400px);
  }
  30% {
...
const Toastify__spin = keyframes`
  from {
...
export const WrapperToastify = styled('div')`
  ${({ theme }) => css`
    .Toastify {
